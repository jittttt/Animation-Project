...
A red line moving from left to right highlights through each randomly generated line and once the red line reaches the last line on the furthest right
side, the line on the left side is changed to create a shortest to longest order. 
